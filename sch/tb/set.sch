...
C {vsource.sym} -590 1620 0 0 {name=V6 value="PULSE(0 1.5 5.15n 20p 20p 4.7n 10n)" savecurrent=false}
...
meas tran vcm_avg AVG vcm FROM=1u TO=2u
let Vinn = v(Vi1_)-v(Vi2_)
let Voutt = v(Vo1_)-v(Vo2_)
meas tran vin_pp  PP Vinn from=1u to=2u
meas tran vout_pp PP Voutt from=1u to=2u

meas tran t_settle TRIG AT=1.49516u TARG v(Voutt) VAL='vout_pp*0.5*0.999' RISE=1
*meas tran t_settle TRIG v(phi2) VAL=0.75 RISE=1 TD=1.49u TARG v(Voutt) VAL='vout_pp*0.5*0.999' RISE=1
...
C {vsource.sym} -360 1630 0 0 {name=V8 value="PULSE(1.5 0 5.15n 20p 20p 4.7n 10n)" savecurrent=false}
...
C {vsource.sym} -290 1230 0 1 {name=V4 value="PULSE(-100m 100m 1.49u 20p 20p 1u 2u)" savecurrent=false}
C {vsource.sym} -190 1250 2 0 {name=V3 value="PULSE(-100m 100m 1.49u 20p 20p 1u 2u)" savecurrent=false}
